...
*
* Based on android.dart originally written by
...
class OhosAotBundle extends Target {
  ...
  @override
  String get name =>
      'ohos_aot_bundle_${getNameForBuildMode(dependency.buildMode)}_'
      '${getNameForTargetPlatform(dependency.targetPlatform)}';
...
class OhosAot extends AotElfBase {
  ...
  @override
  String get name => 'ohos_aot_${getNameForBuildMode(buildMode)}_'
