...
class ThemeData with Diagnosticable {
  ...
  factory ThemeData({
    ...
    useMaterial3 = (platform == TargetPlatform.ohos && kDebugMode) ? false : (useMaterial3 ?? false);
  ...
  ThemeData copyWith({
    ...
    return ThemeData.raw(
      ...
      useMaterial3: ((platform ?? this.platform ) == TargetPlatform.ohos && kDebugMode) ? false : (useMaterial3 ?? this.useMaterial3),
